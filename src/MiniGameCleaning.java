...
public class MiniGameCleaning extends JFrame {
    ...
    private ImageIcon image2 = new ImageIcon("src/resource/typing_game/background.png");
    ...
    public MiniGameCleaning() {
        layer = new JLayeredPane() {
            ...
            public void paintComponent(Graphics g) {
                ...
                try {
                image1 = new ImageIcon("src/resource/cleaning_game/background.png");
...
//        layer.add(Challenge2 = new addJLayerPaneBackGround("src/resource/cleaning_game/background2.png", "Challenge2"));
        ...
        layer.add(Button1 = new JLabel(new ImageIcon("src/resource/cooking_game/button1.png")) {{
            setBounds(50, 30, 85, 85);
            addMouseListener(new ActionHandlerOfCleaning(MiniGameCleaning.this, Button1));
        }});

        layer.add(Button2 = new JLabel(new ImageIcon("src/resource/cooking_game/button1.png")) {{
...
//        CleaningMission1 myTEstt = new CleaningMission1("src/resource/cleaning_game/puzzle1_1.png", 377, 482, 48, 123);
//        myTEstt.setBounds(0, 0, getWidth(), getHeight());


//        CleaningMission1 puzzle2 = new CleaningMission1("src/resource/cleaning_game/puzzle1_2.png", 0, 0, 488, 490, 235);
//        puzzle2.setBounds(401, -15, 1280, 720);
//        panel.add(puzzle2);


//        panel.add(new CleaningMission1("src/resource/cleaning_game/puzzle1_1.png", 377, 482, 48, 123),  Integer.valueOf(11));
