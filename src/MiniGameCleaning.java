...
public class MiniGameCleaning extends JFrame {
    ...
    public MiniGameCleaning() {
        ...
        ScoreBoardBG.add(ScoreBoard_EarnPoints = new SceneModify().createJLabelWithFont(108,260,265,50, 255, 20, "src/resource/fonts/RemboyRegular.ttf", "Heart Collection: 100" , true),  Integer.valueOf(1));
