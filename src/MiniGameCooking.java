...
public class MiniGameCooking extends JFrame {
    ...
    public MiniGameCooking() {
        ...
        //Bento HitBox
        layer.add(BentoHitBox1 = new SceneModify().newJButton(123, 200, 224, 370, handler, null), Integer.valueOf(8));
        layer.add(BentoHitBox2 = new SceneModify().newJButton(364, 200, 251, 175, handler, null), Integer.valueOf(8));
        layer.add(BentoHitBox3 = new SceneModify().newJButton(364, 390, 283, 180, handler, null), Integer.valueOf(8));
        //Bento Food
